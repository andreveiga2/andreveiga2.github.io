...
\begin{itemize}
  \item Information Heterogeneity and the Demand for Quality: Evidence from GPs in England \\ 
  with Zach Brown, Christopher Hansman and Jordan Keener

  \item Empirical Contract Design for Multitasking Agents \\ 
  ...
  \item Information Design With Coarse Labels \\ 
